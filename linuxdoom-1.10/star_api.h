 ...
 * Note: This is a simplified version for Doom integration
 * Full version is in Game Integration/NativeWrapper/star_api.h
 */
...
#include "doomtype.h"  // For boolean type
...
boolean star_api_has_item(const char* item_name);
...
// Use item
boolean star_api_use_item(const char* item_name, const char* context);
